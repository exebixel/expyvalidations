...
from expyvalidations.config import CheckException, config_bar_api
from expyvalidations.excel.excel import Excel
...
if __name__ == "__main__":
    servico(ExcelFile("Parametrização Sistema One Beleza.xlsx"))
